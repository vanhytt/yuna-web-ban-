-- ================================================
-- YUNA Videos & Reviews Setup Script (FIXED)
-- ================================================
...
-- 6. RLS Policies cho bảng videos (với unique names)
...
-- 7. RLS Policies cho bảng reviews_videos (với unique names)
-- Cho phép mọi người đọc (kể cả anonymous)
...
-- 8. Insert sample data (nếu table trống)
...
-- ================================================
-- SUCCESS! Tables created with unique policy names
-- ================================================